...
int main (int argc, char** argv)
{
	...
	// initialize_grids -->
	initialize<<<blks, thds>>>(u_0_0_gpu, ux_1_0_gpu, uy_2_0_gpu, uz_3_0_gpu, 0.1, 0.2, 0.30000000000000004, x_max, y_max, z_max, cbx);
	// <--
	...
	long nBytesTransferred = 5 * ((((((x_max*y_max)*(z_max+4))*sizeof (float))+(((x_max*(y_max+4))*z_max)*sizeof (float)))+((((x_max+4)*y_max)*z_max)*sizeof (float)))+(((x_max*y_max)*z_max)*sizeof (float)));
	
	// warm up
	// compute_stencil -->
	divergence<<<blks, thds>>>(( & u_0_0_out_gpu), u_0_0_gpu, ux_1_0_gpu, uy_2_0_gpu, uz_3_0_gpu, 0.4, 0.5, 0.6, x_max, y_max, z_max, cbx);
	// <--
	...
	{
		// compute_stencil -->
		divergence<<<blks, thds>>>(( & u_0_0_out_gpu), u_0_0_gpu, ux_1_0_gpu, uy_2_0_gpu, uz_3_0_gpu, 0.7, 0.7999999999999999, 0.8999999999999999, x_max, y_max, z_max, cbx);
		// <--
