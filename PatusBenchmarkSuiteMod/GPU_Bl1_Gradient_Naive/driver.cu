...
int main (int argc, char** argv)
{
	...
	// warm up
	// compute_stencil -->
	gradient<<<blks, thds>>>(( & ux_1_0_out_gpu), ( & uy_2_0_out_gpu), ( & uz_3_0_out_gpu), u_0_0_gpu, ux_1_0_gpu, uy_2_0_gpu, uz_3_0_gpu, 0.4, 0.5, 0.6, x_max, y_max, z_max, cbx);
	// <--
	...
	{
		// compute_stencil -->
		gradient<<<blks, thds>>>(( & ux_1_0_out_gpu), ( & uy_2_0_out_gpu), ( & uz_3_0_out_gpu), u_0_0_gpu, ux_1_0_gpu, uy_2_0_gpu, uz_3_0_gpu, 0.7, 0.7999999999999999, 0.8999999999999999, x_max, y_max, z_max, cbx);
		// <--
