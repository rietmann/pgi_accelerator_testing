...
#pragma omp parallel
	...
	long nBytesTransferred = 5 * ((((((((x_max+3)*(y_max+3))*(z_max+3))*sizeof (double))+(((x_max*y_max)*z_max)*sizeof (double)))+(((x_max*y_max)*z_max)*sizeof (double)))+(((x_max*y_max)*z_max)*sizeof (double)))+(((x_max*y_max)*z_max)*sizeof (double)));
