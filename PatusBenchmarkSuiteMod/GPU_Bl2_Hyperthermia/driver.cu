...
/* "best" bench parama(128^3): ./bench 128 128 128 64 2 1 1  */
...
int main (int argc, char** argv)
{
	...
	// initialize_grids -->
	initialize<<<blks, thds>>>(T_0_0_gpu, T_0_1_gpu, c_1_0_gpu, c_2_0_gpu, c_3_0_gpu, c_4_0_gpu, c_5_0_gpu, c_6_0_gpu, c_7_0_gpu, c_8_0_gpu, c_9_0_gpu, x_max, y_max, z_max, tbx, tby, tbz, c);
	// <--
	...
	long nBytesTransferred = 5 * (((((((((((((x_max*y_max)*z_max)*sizeof (float))+(((x_max*y_max)*z_max)*sizeof (float)))+(((x_max*y_max)*z_max)*sizeof (float)))+(((x_max*y_max)*z_max)*sizeof (float)))+(((x_max*y_max)*z_max)*sizeof (float)))+((((x_max+4)*(y_max+4))*(z_max+4))*sizeof (float)))+(((x_max*y_max)*z_max)*sizeof (float)))+(((x_max*y_max)*z_max)*sizeof (float)))+(((x_max*y_max)*z_max)*sizeof (float)))+(((x_max*y_max)*z_max)*sizeof (float)))+(((x_max*y_max)*z_max)*sizeof (float)));
	
//	cudaFuncSetCacheConfig (hyperthermia, cudaFuncCachePreferShared);
	cudaFuncSetCacheConfig (hyperthermia, cudaFuncCachePreferL1);
	
	// warm up
	// compute_stencil -->
	hyperthermia<<<blks, thds>>>(( & T_0_1_out_gpu), T_0_0_gpu, T_0_1_gpu, c_1_0_gpu, c_2_0_gpu, c_3_0_gpu, c_4_0_gpu, c_5_0_gpu, c_6_0_gpu, c_7_0_gpu, c_8_0_gpu, c_9_0_gpu, x_max, y_max, z_max, tbx, tby, tbz, c);
	// <--
