...
int main (int argc, char** argv)
{
	...
	// initialize_grids -->
	initialize<<<blks, thds>>>(u_0_0_gpu, u_0_1_gpu, 0.1, x_max, y_max, z_max, tbx, tby, tbz, c);
	// <--
...
//	cudaFuncSetCacheConfig (upstream_5_3d, cudaFuncCachePreferShared);
	cudaFuncSetCacheConfig (upstream_5_3d, cudaFuncCachePreferL1);

	
	// warm up
	// compute_stencil -->
	upstream_5_3d<<<blks, thds>>>(( & u_0_1_out_gpu), u_0_0_gpu, u_0_1_gpu, 0.2, x_max, y_max, z_max, tbx, tby, tbz, c);
	// <--
	...
	{
		// compute_stencil -->
		upstream_5_3d<<<blks, thds>>>(( & u_0_1_out_gpu), u_0_0_gpu, u_0_1_gpu, 0.30000000000000004, x_max, y_max, z_max, tbx, tby, tbz, c);
		// <--
