...
int main (int argc, char** argv)
{
	...
	// initialize_grids -->
	initialize<<<blks, thds>>>(u_0_0_gpu, u_0_1_gpu, 0.1, x_max, y_max, z_max, cbx);
	// <--
	...
	// warm up
	// compute_stencil -->
	upstream_5_3d<<<blks, thds>>>(( & u_0_1_out_gpu), u_0_0_gpu, u_0_1_gpu, 0.2, x_max, y_max, z_max, cbx);
	// <--
	...
	{
		// compute_stencil -->
		upstream_5_3d<<<blks, thds>>>(( & u_0_1_out_gpu), u_0_0_gpu, u_0_1_gpu, 0.30000000000000004, x_max, y_max, z_max, cbx);
		// <--
