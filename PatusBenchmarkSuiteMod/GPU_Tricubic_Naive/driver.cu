...
int main (int argc, char** argv)
{
	...
	// initialize_grids -->
	initialize<<<blks, thds>>>(u_0_0_gpu, u_0_1_gpu, a_1_0_gpu, b_2_0_gpu, c_3_0_gpu, x_max, y_max, z_max);
	// <--
	...
	// warm up
	// compute_stencil -->
	tricubic_interpolation<<<blks, thds>>>(( & u_0_1_out_gpu), u_0_0_gpu, u_0_1_gpu, a_1_0_gpu, b_2_0_gpu, c_3_0_gpu, x_max, y_max, z_max);
	// <--
