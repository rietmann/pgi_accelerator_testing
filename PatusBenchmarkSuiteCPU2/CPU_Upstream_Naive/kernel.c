				...
				for (p_idx_y=0; p_idx_y<y_max; p_idx_y+=1)
				{
					for (p_idx_x=0; p_idx_x<x_max; p_idx_x+=1)
					{
						...
						*/
						...
						u__u_0[1][_idx9]=(a*((((u__u_0[0][_idx0]+(u__u_0[0][_idx1]+u__u_0[0][_idx2]))*-2.0)+(((u__u_0[0][_idx3]+(u__u_0[0][_idx4]+u__u_0[0][_idx5]))*15.0)+((u__u_0[0][_idx6]+(u__u_0[0][_idx7]+u__u_0[0][_idx8]))*-60.0)))+((u__u_0[0][_idx9]*20.0)+(((u__u_0[0][_idx10]+(u__u_0[0][_idx11]+u__u_0[0][_idx12]))*30.0)+((u__u_0[0][_idx13]+(u__u_0[0][_idx14]+u__u_0[0][_idx15]))*-3.0)))));
					}
				}
			}
		}
